<?php
session_start();
if(isset($_POST['assorted']))
{
	$quantity = $_POST['qty'];
	$flag = false;
	
	$curr_product_order = array();
	$curr_product_order['code'] = 9;	
...
<ul>
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
        	...
        	<img src="assorted/chocolate.jpg">
            </div>
            <div class="col col_13 no_margin_right">
                ...
                <input style="width:150px;height:25px;" type="submit" class="add_to_cart" name="assorted" value="Add to Cart" ></form>
			</div>
            <div class="cleaner h30"></div>
            
            <h5 ><strong>Product Description</strong></h5>
            <p>Amazing flavor, with no added preservatives. Beautifully arranged with Bordeaux™, chocolate-covered nuts, creamy caramels and more. Featuring our aged milk and dark chocolate.  </p>	
