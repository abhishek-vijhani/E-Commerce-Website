<?php
session_start();
if(isset($_POST['littleheart']))
{
	$quantity = $_POST['qty'];
	$flag = false;
	
	$curr_product_order = array();
	$curr_product_order['code'] = 14;	
	...
	if(isset($_SESSION['cart']))
	{
		...
		{
			if($_SESSION['cart'][$index]['code'] == 14)
			{
				$flag = TRUE;
...
<ul>
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
        	...
        	<img src="exotic/littleheart.jpg">
            </div>
            <div class="col col_13 no_margin_right">
                ...
                <input style="width:150px;height:25px;" type="submit" class="add_to_cart" name="littleheart" value="Add to Cart" ></form>
			</div>
            <div class="cleaner h30"></div>
            
            <h5 ><strong>Product Description</strong></h5>
            <p>Little Hearts are small heart-shaped sugar candies</p>	
