...
if(isset($_POST['mp3']))
{
	...
	if(isset($_SESSION['event']))
	{
		...
		{
			if($_SESSION['event'][$index]['code'] == 9)
			{
				$flag = TRUE;
...
<ul>
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
        	<h2>Marriage Pack 3</h2>
            <div class="col col_13">
        	<img src="marriageE/3.jpg">
            </div>
            <div class="col col_13 no_margin_right">
               ...
               Quantity (No. of Packs): <input type = "text" style="width:40px; position:relative; left:28px;" name = "qty" value="1" /><br /><br />
                <input style="width:150px;height:25px;" type="submit" name="mp3" value="Add to Cart" class="add_to_cart"></form>
			</div>
