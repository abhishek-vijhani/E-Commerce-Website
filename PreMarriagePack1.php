...
if(isset($_POST['pm1']))
{
	...
	if(isset($_SESSION['event']))
	{
		...
		{
			if($_SESSION['event'][$index]['code'] == 1)
			{
				$flag = TRUE;
	...
	<div id="templatemo_header">
        ...
        <div id="header_right">
            <ul type="none">                
				...
				<font face="Calibri" size="+2">|<a href=#>Track your order</a></font></li>
            </ul>
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
            ...
            <div class="col col_13 no_margin_right">
				...
				Quantity (No. Of Packs): <input type = "text" style="width:40px; position:relative; left:28px;" name = "qty" value="1" /><br /><br />                <input style="width:150px;height:25px;" type="submit" name="pm1" value="Book an Event" class="add_to_cart"></form>
			</div>
            <div class="cleaner h30"></div>
            
            <h4><strong>Product Description</strong></h4><hr />
            <p>Pre Marriage Pack 1</p>	
