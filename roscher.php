<?php
session_start();
if(isset($_POST['roscher']))
{
	$quantity = $_POST['qty'];
	$flag = false;
	
	$curr_product_order = array();
	$curr_product_order['code'] = 12;	
	...
	if(isset($_SESSION['cart']))
	{
		...
		{
			if($_SESSION['cart'][$index]['code'] == 12)
			{
				$flag = TRUE;
				$_SESSION['cart'][$index]['qty'] = $_SESSION['cart'][$index]['qty'] + $quantity;				
				break;
			}
		}
		...
		if ($flag == FALSE)
		{
			$_SESSION['cart'][] = $curr_product_order;
		}
	}
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
            ...
            <div class="col col_13 no_margin_right">
                ...
                Quantity: <input type = "text" style="width:40px; position:relative; left:110px;" name = "qty" value="1"><br /><br />
                <input style="width:150px;height:25px;" type="submit" class="add_to_cart" name="roscher" value="Add to Cart" ></form>
			</div>
            <div class="cleaner h30"></div>
            
            <h5 ><strong>Product Description</strong></h5>
            <p> The chocolates consist of a whole roasted hazelnut encased in a thin wafer shell filled with hazelnut cream including vegetable oil and covered in milk chocolate and chopped hazelnuts.</p>	
