...
<ul>
    ...
    <div id="templatemo_middle">
    	<img src="specialOccasion/cover.jpg" alt="Image 01" />
    	<h1 style="font-family:Calibri"><u><br><br>Special Occasions</u></h1>
    ...
    <div id="">
        	...
        	<div class="col col_14 product_gallery">
            	<a href="specialoccasion1.php"><img src="specialOccasion/1.jpg"  />
                <h3>Special Pack 1 </h3></a>
                <p class="product_price"> Rs 850</p>
                <a href="specialoccasion1.php" >View Product</a>
            </div>        	
            <div class="col col_14 product_gallery">
            	<a href="specialoccasion2.php"><img src="specialOccasion/2.jpg"/>
                <h3>Special Pack 2</h3></a>
                <p class="product_price">Rs 850</p>
                <a href="specialoccasion2.php" >View Product</a>
            </div>        	
            <div class="col col_14 product_gallery no_margin_right">
            	<a href="specialoccasion3.php"><img src="specialOccasion/3.jpg" />
                <h3>Special Pack 3</h3></a>
                <p class="product_price">Rs 850</p>
                <a href="specialoccasion3.php" >View Product</a>
            </div>
