...
if(isset($_POST['pm3']))
{
	...
	if(isset($_SESSION['event']))
	{
		...
		{
			if($_SESSION['event'][$index]['code'] == 3)
			{
				$flag = TRUE;
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
            ...
            <div class="col col_13 no_margin_right">
                ...
                <input style="width:150px;height:25px;" type="submit" name="pm3" value="Book an Event" class="add_to_cart"></form>
			</div>
            <div class="cleaner h30"></div>
            
            <h4><strong>Product Description</strong></h4><hr />
            <p>Pre Marriage Pack 3</p>	
