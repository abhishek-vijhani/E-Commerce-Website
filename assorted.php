...
<div id="templatemo_wrapper">
	<div id="templatemo_header">
    	<div id="site_title">
            ...
            <ul type="none">                
                <li><a href ="shoppingcart.php"><img src="images/cart.png" /></a>
				<font face="Calibri" size="+2">|<a href="trackorder.php"><b>Track order</b></a></font></li>
            </ul>
...
<ul>
    ...
    <div id="templatemo_middle">
    	<img src="assorted/assort.jpg" alt="Image 01" />
    	<h1 style="font-family:Calibri"><u>Assorted</u></h1>
        <p >Amazing flavor, with no added preservatives. Enticingly arranged with milk and dark chocolate-covered nuts, buttery caramels.</p>
    ...
    <div id="">
        	<div class="col col_14 product_gallery">
            	<a href="assortedchoc.php"><img src="EditedAssorted/chocolate.jpg" alt="Product 01" /></a>
                <h3>Assorted</h3>
           ...
           <h4>Suggested for you</h4>
            ...
            <div class="col col_14 product_gallery">
                ...
                <h3>Oreo</h3>
                <p class="product_price">Rs 950</p>
                <a href="ored.php" >View Product</a>
            </div>        	
            <div class="col col_14 product_gallery no_margin_right">
            	<a href="crunch.php"><img src="EditedSimple/crunch.jpg" alt="Product 03" /></a>
                <h3>Crunch</h3>
   ...
   <div id="templatemo_footer">
        ...
        <div class="col col_16">
            ...
            <ul class="footer_menu">
                ...
                <li><a href="productdetails.php">Services</a></li>
