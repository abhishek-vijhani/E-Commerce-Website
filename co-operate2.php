...
if(isset($_POST['cp2']))
{
	...
	if(isset($_SESSION['event']))
	{
		...
		{
			if($_SESSION['event'][$index]['code'] == 11)
			{
				$flag = TRUE;
        ...
        <div id="content">
            ...
            <div class="col col_13 no_margin_right">
               ...
               Quantity (No. of Packs): <input type = "text" style="width:40px; position:relative; left:28px;" name = "qty" value="1" /><br /><br />
                <input style="width:150px;height:25px;" type="submit" name="cp2" value="Add to Cart" class="add_to_cart"></form>
			</div>
