<?php
session_start();
if(isset($_POST['fruitnut']))
{
	$quantity = $_POST['qty'];
	$flag = false;
	
	$curr_product_order = array();
	$curr_product_order['code'] = 2;	
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
            ...
            <div class="col col_13 no_margin_right">
                ...
                <input style="width:150px;height:25px;" type="submit" class="add_to_cart" name="fruitnut" value="Add to Cart" ></form>
			</div>
            <div class="cleaner h30"></div>
            
            <h5 ><strong>Product Description</strong></h5>
            <p>It contains, as the fruit and nut raisins and almonds however in early versions of the bar the nuts were mixed nuts, including Brazil nuts, rather than just almonds.</p>	
