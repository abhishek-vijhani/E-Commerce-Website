...
if(isset($_POST['oreo']))
{
	...
	if(isset($_SESSION['cart']))
	{
		...
		{
			if($_SESSION['cart'][$index]['code'] == 13)
			{
				$flag = TRUE;
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
            ...
            <div class="col col_13 no_margin_right">
                ...
                <input style="width:150px;height:25px;" type="submit" class="add_to_cart" name="oreo" value="Add to Cart" ></form>
			</div>
            <div class="cleaner h30"></div>
            
            <h5 ><strong>Product Description</strong></h5>
            <p>Oreo is a sandwich cookie consisting of two chocolate wafers with a sweet cream filling in between.</p>	
