...
if(isset($_POST['bp2']))
{
	...
	if(isset($_SESSION['event']))
	{
		...
		{
			if($_SESSION['event'][$index]['code'] == 5)
			{
				$flag = TRUE;
...
<ul>
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
        	<h2>Birthday Pack 2</h2>
            <div class="col col_13">
        	<img src="birthdayE/2.jpg">
            </div>
            <div class="col col_13 no_margin_right">
               ...
               Quantity (No. of Packs): <input type = "text" style="width:40px; position:relative; left:28px;" name = "qty" value="1" /><br /><br />
                <input style="width:150px;height:25px;" type="submit" name="bp2" value="Add to Cart" class="add_to_cart"></form>
			</div>
