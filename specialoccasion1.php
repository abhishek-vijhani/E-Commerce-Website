...
if(isset($_POST['sp1']))
{
	...
	if(isset($_SESSION['event']))
	{
		...
		{
			if($_SESSION['event'][$index]['code'] == 13)
			{
				$flag = TRUE;
...
<ul>
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
        	...
        	<img src="specialoccasionE/1.jpg">
            </div>
            <div class="col col_13 no_margin_right">
               ...
               Quantity (No. of Packs): <input type = "text" style="width:40px; position:relative; left:28px;" name = "qty" value="1" /><br /><br />
                <input style="width:150px;height:25px;" type="submit" name="sp1" value="Add to Cart" class="add_to_cart"></form>
			</div>
            <div class="cleaner h30"></div>
            
            <h4><strong>Product Description</strong></h4><hr />
            <p>Special Occasion Gift 1</p>	
