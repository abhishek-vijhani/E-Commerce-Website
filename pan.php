...
if(isset($_POST['pan']))
{
	...
	if(isset($_SESSION['cart']))
	{
		...
		{
			if($_SESSION['cart'][$index]['code'] == 15)
			{
				$flag = TRUE;
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
            ...
            <div class="col col_13 no_margin_right">
                ...
                <input style="width:150px;height:25px;" type="submit" class="add_to_cart" name="pan" value="Add to Cart" ></form>
			</div>
            <div class="cleaner h30"></div>
            
            <h5 ><strong>Product Description</strong></h5>
            <p>All products are egg free .
			   All products are made with dark chocolate especially imported.
			   Use only the finest ingredients for chocolate and fillings.</p>	
