...
<ul>
    ...
    <div id="templatemo_middle">
    	<img src="birthdays/cover.jpg" alt="Image 01" />
    	<h1 style="font-family:Calibri"><u><br><br>Birthdays</u></h1>
    ...
    <div id="">
        	...
        	<div class="col col_14 product_gallery">
            	<a href="birthdaypack1.php"><img src="birthdays/1.jpg"  />
                <h3>Birthday Pack 1 </h3></a>
                <p class="product_price"> Rs 450</p>
                <a href="birthdaypack1.php" >View Product</a>
            </div>        	
            <div class="col col_14 product_gallery">
            	<a href="birthdaypack2.php"><img src="birthdays/2.jpg"/>
                <h3>Birthday Pack 2</h3></a>
                <p class="product_price">Rs 450</p>
                <a href="birthdaypack2.php" >View Product</a>
            </div>        	
            <div class="col col_14 product_gallery no_margin_right">
            	<a href="birthdaypack3.php"><img src="birthdays/3.jpg" />
                <h3>Birthday Pack 3</h3></a>
                <p class="product_price">Rs 450</p>
                <a href="birthdaypack3.php" >View Product</a>
            </div>
