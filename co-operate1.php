...
if(isset($_POST['cp1']))
{
	...
	if(isset($_SESSION['event']))
	{
		...
		{
			if($_SESSION['event'][$index]['code'] == 10)
			{
				$flag = TRUE;
...
<ul>
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
        	<h2>Co-Operate Pack 1</h2>
            <div class="col col_13">
        	<img src="co-operateE/1.jpg">
            </div>
            <div class="col col_13 no_margin_right">
               ...
               Quantity (No. of Packs): <input type = "text" style="width:40px; position:relative; left:110px;" name = "qty" value="1" /><br /><br />
                <input style="width:150px;height:25px;" type="submit" name="cp1" value="Add to Cart" class="add_to_cart"></form>
			</div>
