...
if(isset($_POST['cafe']))
{
	...
	if(isset($_SESSION['cart']))
	{
		...
		{
			if($_SESSION['cart'][$index]['code'] == 11)
			{
				$flag = TRUE;
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
            ...
            <div class="col col_13 no_margin_right">
                ...
                <input style="width:150px;height:25px;" type="submit" class="add_to_cart" name="cafe" value="Add to Cart" ></form>
			</div>
