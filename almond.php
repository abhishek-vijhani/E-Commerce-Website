<?php
session_start();
if(isset($_POST['almond']))
{
	$quantity = $_POST['qty'];
	$flag = false;
	
	$curr_product_order = array();
	$curr_product_order['code'] = 1;	
        ...
        <div id="content">
            ...
            <div class="col col_13 no_margin_right">
               ...
               Quantity: <input type = "text" style="width:40px; position:relative; left:110px;" name = "qty" value="1" /><br /><br />
                <input style="width:150px;height:25px;" type="submit" class="add_to_cart" name="almond" value="Add to Cart" ></form>
			</div>
            <div class="cleaner h30"></div>
            
            <h4><strong>Product Description</strong></h4><hr />
            <p>A tasty crisp almond surrounded by Tasty Dark Chocolate.<br />The simple and elegant as it always has been, with just a special touch from Choco Melange.</p>	
