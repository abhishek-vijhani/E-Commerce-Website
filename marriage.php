...
<ul>
    ...
    <div id="templatemo_middle">
    	<img src="marriage/cover.jpg" alt="Image 01" />
    	<h1 style="font-family:Calibri"><u><br><br>Marriage</u></h1>
    ...
    <div id="">
        	...
        	<div class="col col_14 product_gallery">
            	<a href="marriagepack1.php"><img src="marriage/1.jpg"  />
                <h3>Marriage Pack 1 </h3></a>
                <p class="product_price"> Rs 1000</p>
                <a href="marriagepack1.php" >View Product</a>
            </div>        	
            <div class="col col_14 product_gallery">
            	<a href="marriagepack2.php"><img src="marriage/2.jpg"/>
                <h3>Marriage Pack 2</h3></a>
                <p class="product_price">Rs 1000</p>
                <a href="marriagepack2.php" >View Product</a>
            </div>        	
            <div class="col col_14 product_gallery no_margin_right">
            	<a href="marriagepack3.php"><img src="marriage/3.jpg" />
                <h3>Marriage Pack 3</h3></a>
                <p class="product_price">Rs 1000</p>
                <a href="marriagepack3.php" >View Product</a>
            </div>
