...
<ul>
    ...
    <div id="templatemo_main">
        ...
        <div id="content">
        	...
        	<img src="simple/butterscotch.jpg">
            </div>
            <div class="col col_13 no_margin_right">
                ...
                <input style="width:150px;height:25px;" type="submit" class="add_to_cart" name="butterscotch" value="Add to Cart" ></form>
			</div>
            <div class="cleaner h30"></div>
            
            <h5 ><strong>Product Description</strong></h5>
            <p>A delicious center of firm brown sugar, vanilla and heavy cream is covered in milk chocolate.</p>	
