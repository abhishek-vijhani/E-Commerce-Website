...
<ul>
    ...
    <div id="templatemo_middle">
    	<img src="co-operate/cover.jpg" alt="Image 01" />
    	<h1 style="font-family:Calibri"><u><br><br>Co-Operate Gifts</u></h1>
    ...
    <div id="">
        	...
        	<div class="col col_14 product_gallery">
            	<a href="co-operate1.php"><img src="co-operate/1.jpeg"  />
                <h3>Co Operate Pack 1 </h3></a>
                <p class="product_price"> Rs 450</p>
                <a href="co-operate1.php" >View Product</a>
            </div>        	
            <div class="col col_14 product_gallery">
            	<a href="co-operate2.php"><img src="co-operate/2.jpg"/>
                <h3>Co Operate Pack 2</h3></a>
                <p class="product_price">Rs 450</p>
                <a href="co-operate2.php" >View Product</a>
            </div>        	
            <div class="col col_14 product_gallery no_margin_right">
            	<a href="co-operate3.php"><img src="co-operate/3.jpg" />
                <h3>Co Operate 3</h3></a>
                <p class="product_price">Rs 450</p>
                <a href="co-operate3.php" >View Product</a>
            </div>
            <div class="cleaner"></div>
       <!-- END of content -->
        <div class="cleaner"></div>
