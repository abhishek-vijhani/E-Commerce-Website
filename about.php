...
<title>Choco Melange - About</title>
...
<ul>
    ...
    <div id="templatemo_main">
        ...
        <div style="left:13px" id="">
        	
            <p style="font-family:Calibri; font-size:35px; color:#333333">About Us</p><hr />
        <p style="font-family:Calibri; position:relative; left:13px; font-size:18px; color:#333333">Chocolate making is an art!
Every single detail counts when it comes to creating the finest chocolate. The Choco Melange, real masters of their craft, are always striving to offer you a chocolate that melts tenderly in your mouth and gently caresses all your senses.<br /> 

Choco Melange is recognized as a leader in the market for premium quality chocolate, offering a large selection of products in more than 20 states in the country.<br /> It has become known as one of the most innovative and creative companies making premium chocolate (Simple , Assorted , Exotic).
		</p>
        <div class="cleaner"></div>
        </div> <!-- END of content -->
        <div class="cleaner"></div>
