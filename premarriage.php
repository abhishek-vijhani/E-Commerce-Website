...
<ul>
    ...
    <div id="templatemo_middle">
    	<img src="premarriage/cover.jpg" alt="Image 01" />
    	<h1 style="font-family:Calibri"><u><br><br>Pre Marriage Parties</u></h1>
    ...
    <div id="">
        	...
        	<div class="col col_14 product_gallery">
            	<a href="PreMarriagePack1.php"><img src="premarriage/1.jpg"  />
                <h3>Pre Marriage Pack 1 </h3></a>
                <p class="product_price"> Rs 650</p>
                <a href="PreMarriagePack1.php" >View Product</a>
            </div>        	
            <div class="col col_14 product_gallery">
            	<a href="PreMarriagePack2.php"><img src="premarriage/2.jpg"/>
                <h3>Pre Marriage Pack 2</h3></a>
                <p class="product_price">Rs 650</p>
                <a href="PreMarriagePack2.php" >View Product</a>
            </div>        	
            <div class="col col_14 product_gallery no_margin_right">
            	<a href="PreMarriagePack3.php"><img src="premarriage/3.jpg" />
                <h3>Pre Marriage Pack 3</h3></a>
                <p class="product_price">Rs 650</p>
                <a href="PreMarriagePack3.php" >View Product</a>
            </div>
